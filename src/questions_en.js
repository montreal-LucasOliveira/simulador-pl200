export const questionsDataEn = [
  ...
  },
  {
    ...
    "explanation": {
      ...
      "dicaOuro": "Untied the problem of the disabled owner that choked the original Classic Workflows? Become the process owner globally (Change Owner) + OBRIGATORIAMENTE CANCELE as instâncias congeladas paradas lá trás."
    },
    "difficulty": "beginner",
    "domain": "Microsoft Power Automate cloud flows"
  },
  ...
  },
  {
    ...
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6007] You were assigned to implement fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
    ...
    "explanation": {
      "intro": "Direct PL-200 Mapping (External Domain):",
      "papoReto": "In this business scenario, the answer is invariably 'System Topic'. These caliber tools are tested purely on the real exam.",
      "puloDoGato": "Did you identify the integration resource? It is the 'standard' connection solution.",
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam."
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6008] You were assigned to store customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6009] You were assigned to design a lookup relationship using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6010] You were assigned to handle exceptions in a flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6011] You were assigned to add business logic in a Model-driven app using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6012] You were assigned to embed a chart in a portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6013] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6014] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6015] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6016] You were assigned to implement a fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6017] You were assigned to store a customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6018] You were assigned to design a lookup relationship using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6019] You were assigned to handle exceptions in a flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6020] You were assigned to add business logic in a Model-driven app using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6021] You were assigned to embed a chart in a portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6022] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6023] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6024] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6025] You were assigned to implement a fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6026] You were assigned to store a customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6027] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6028] You were assigned to implement a fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6029] You were assigned to store a customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6030] You were assigned to track record history using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Audit logs",
      "Manual log table",
      "Excel log",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6031] You were assigned to embed interactive data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Report",
      "Static Image",
      "CSV Link",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6032] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6033] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6034] You were assigned to design a lookup relationship using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6035] You were assigned to handle exceptions in flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6036] You were assigned to add business logic in Model-driven app using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6037] You were assigned to embed a chart in a portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6038] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6039] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6040] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6041] You were assigned to implement manual fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6049] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6050] You were assigned to implement manual fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6051] You were assigned to store customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6052] You were assigned to design lookup relation using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6053] You were assigned to handle exception in flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6054] You were assigned to add business logic in Model-driven using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6055] You were assigned to embed chart in portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6056] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6057] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6058] You were assigned to implement escalation using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Trigger Action",
      "End User Request",
      "End of topic",
      "Hand off to Omnichannel (Escalation)"
    ],
    "correctAnswer": 3,
    "explanation": {
      "intro": "Direct PL-200 Mapping (External Domain):",
      "papoReto": "In this business scenario, the answer is invariably 'Hand off to Omnichannel (Escalation)'. These caliber tools are tested purely on the real exam.",
      "puloDoGato": "Did you identify the integration resource? It is the 'standard' connection solution.",
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam."
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6059] You were assigned to design a lookup relationship using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6060] You were assigned to handle exception in flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6061] You were assigned to add business logic in Model-driven using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6062] You were assigned to embed chart in portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6063] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6064] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6065] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6066] You were assigned to implement manual fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6067] You were assigned to store customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6068] You were assigned to design lookup relation using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6069] You were assigned to handle exception in flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6070] You were assigned to add business logic in Model-driven using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6071] You were assigned to embed chart in portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6072] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6073] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6074] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6075] You were assigned to implement manual fallback using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "System Topic",
      "Dialog Root",
      "Custom Entity",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6076] You were assigned to store customer name using Chatbot Creation with Copilot Studio. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Bot Variable",
      "Dataverse Table",
      "Session Storage",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "[Exclusive Scenario #6077] You were assigned to design lookup relation using Microsoft Dataverse. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "N:1 Relationship (Many-to-One)",
      "N:N Relationship",
      "Text ID field",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Automate",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6078] You were assigned to handle exception in flow using Microsoft Power Automate. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Configure Run After",
      "Try/Catch code",
      "Manual Stop",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Apps",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6079] You were assigned to add business logic in Model-driven using Microsoft Power Apps. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Model Business Rule",
      "Canvas formula",
      "JavaScript custom",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6080] You were assigned to embed chart in portal using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power BI Embedded component",
      "Native IFrame tag",
      "PowerApps Canvas",
  ...
  },
  {
    ...
    "domain": "Power BI Integration",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6081] You were assigned to update m365 chart data using Power BI Integration. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Power Automate trigger schedule",
      "Dynamics Workflow",
      "SQL Trigger",
  ...
  },
  {
    ...
    "domain": "Microsoft Power Pages",
    "difficulty": "advanced",
    "text": "[Exclusive Scenario #6082] You were assigned to provide anonymous external portal access using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "Anonymous Authentication Enabled",
      "Entra ID required",
      "Global Premium License",
  ...
  },
  {
    ...
    "domain": "Chatbot Creation with Copilot Studio",
    "difficulty": "intermediate",
    "text": "[Exclusive Scenario #6083] You were assigned to display a list table using Microsoft Power Pages. At BetaCorp, the director demanded a specific approach in the specification. What is the ideal system approach?",
    "options": [
      "List Component (Entity List)",
      "Custom Liquid template",
      "Canvas Gallery",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "Which native Dataverse feature allows restricting data based on the macro level of the organization and user hierarchy? Scenario 2",
    "options": [
      "Business Rules",
      "Business Units and Security Roles",
      "Plugins",
    ...
    "correctAnswer": 1,
    "explanation": {
      "intro": "Resource Overview in MS Power Platform:",
      "papoReto": "The best approach recommended by Microsoft is to actively use 'Business Units and Security Roles'. The main reason is that, under the scope of the PL-200 exam, this is the standard (native) tool designed to fill this exact gap without requiring extensive custom development.",
      "puloDoGato": "During the exam, if in doubt and the scenario mentions this, immediately associate it with the use of Business Units. Microsoft always favors the least invasive solution.",
      "cascasDeBanana": [
        "The option involving 'Plugins' seems tempting, but it acts at an incorrect governance/architecture level for this specific case.",
        "The other alternatives either require parallel premium licenses or refer to components that do not natively integrate in this isolated scenario."
      ],
      "dicaOuro": "Always validate license limits and security. Not everything that can be done SHOULD be done if a simple tool already solves it."
    }
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "Which native Dataverse feature allows restricting data based on the macro level of the organization and user hierarchy? Scenario 3",
    "options": [
      "Business Rules",
      "Business Units and Security Roles",
      "Plugins",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "Which native Dataverse feature allows restricting data based on the macro level of the organization and user hierarchy? Scenario 4",
    "options": [
      "Business Rules",
      "Business Units and Security Roles",
      "Plugins",
  ...
  },
  {
    ...
    "domain": "Microsoft Dataverse",
    "difficulty": "beginner",
    "text": "Which native Dataverse feature allows restricting data based on the macro level of the organization and user hierarchy? Scenario 5",
    "options": [
      "Business Rules",
      "Business Units and Security Roles",
      "Plugins",
